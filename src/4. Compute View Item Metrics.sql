...
SELECT view_binary.test_assignment,
       COUNT(DISTINCT view_binary.item_id) AS count_views,
       SUM(view_binary.view_bin_30d) AS sum_view_binary_30d,
       AVG(view_binary.view_bin_30d) AS avg_view_binary_30d
FROM
